...
namespace Flocking
{
    public class DisturbPlayer : MonoBehaviour
    {
        ...
        private void Separation()
        {
            ...
            if (curColliderHit.CompareTag(peepTag))
            {
                ...
                // Ignore peeps that are not the player.
                //new
                int layerPlayer = LayerMask.NameToLayer("Leader");
                if (otherPeed.gameObject.layer != layerPlayer) return;
